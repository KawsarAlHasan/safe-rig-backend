...
// create new CardSubmission
export const createNewCardSubmissionByRigAdmin = catchAsync(
  async (req: Request, res: Response) => {
    ...
    const result = await submitCardByRigAdminService(payload);
...
export const getAllCardSubmission = catchAsync(
  async (req: Request, res: Response) => {
    ...
    const result = await getCardSubmissionService(
      req.query,
      companyId,
      rigIdResolve,
    );
