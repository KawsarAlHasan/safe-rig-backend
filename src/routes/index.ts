...
import { DebriefQuestionRoutes } from "../app/modules/debriefsManagement/debriefQuestion/debriefQuestion.route";
...
const apiRoutes = [
  ...
  {
    path: "/debrief-question",
    route: DebriefQuestionRoutes,
  },
